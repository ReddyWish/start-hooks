...
import withFunctions from "./hocExercisePractice/withFunctions";
import SimpleComponent from "./hocExercisePractice/SimpleComponent";

const HocExercise = () => {
    const ComponentWithHoc = withFunctions(SimpleComponent);
    console.log(ComponentWithHoc);
    return (
      <>
